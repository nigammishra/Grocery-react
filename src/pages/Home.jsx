                  ...
                  <div className="d-lg-flex align-items-center">
                    ...
                    <div className="ms-lg-4">
                      ...
                      <span>
                        ...
                        <span className="text-primary">$30</span> off on your
                        first order.
                      </span>
                    </div>
                  </div>
        ...
        <section className="my-lg-14 my-8">
          <div className="container ">
            <div className="row">
              ...
              <h3 className='h3style' data-title="Shop Popular Categories">Shop Popular Categories</h3>
                  ...
                  <div className="wt-icon-box-wraper center p-a25 p-b50 m-b30 bdr-1 bdr-gray bdr-solid corner-radius step-icon-box bg-white v-icon-effect">
                    ...
                    <div className="icon-content">
                      ...
                      <p>
                        ...
                        cashback offers to top it off. Get best pricess &amp;
                        offers.
                      </p>
                    </div>
                  </div>
